  ...
  return parley(
    ...
    function (done){
      ...
      _self.tenancy(req, ignore_tenancy).then(model => {
        ...
        WLModel.find(req, query.criteria, function _afterFinding(err, foundRecords) {
          ...
          //  ║╣ ╔╩╦╝║╣ ║  ║ ║ ║ ║╣   │  ├┬┘├┤ ├─┤ │ ├┤ ├┤ ├─┤│  ├─┤  │─┼┐│ │├┤ ├┬┘└┬┘
          //  ╚═╝╩ ╚═╚═╝╚═╝╚═╝ ╩ ╚═╝  └─┘┴└─└─┘┴ ┴ ┴ └─┘└─┘┴ ┴└─┘┴ ┴  └─┘└└─┘└─┘┴└─ ┴
          req.tenancyOneTime = WLModel.multitenant;
          Archive.createEach(req, archives, function _afterCreatingEach(err) {
            if (err) { return done(err); }
            ...
            //  ║╣ ╔╩╦╝║╣ ║  ║ ║ ║ ║╣    ││├┤ └─┐ │ ├┬┘│ │└┬┘  │─┼┐│ │├┤ ├┬┘└┬┘
            //  ╚═╝╩ ╚═╚═╝╚═╝╚═╝ ╩ ╚═╝  ─┴┘└─┘└─┘ ┴ ┴└─└─┘ ┴   └─┘└└─┘└─┘┴└─ ┴
            WLModel.destroy(req, query.criteria, function _afterDestroying(err) {
              if (err) { return done(err); }
